...
**73 sources.** The 42 collected on 2026-07-24 were verified against their primary page — title and first author confirmed before recording. The 31 added on 2026-07-25 were collected to a different standard and say so per record: 28 agent verified, 3 author verified, and 1 recorded from its abstract only. Every record names its own verification level in [`research/sources.yaml`](../research/sources.yaml). Nothing here is cited from memory.

<!-- /generated:source-provenance -->

Eight findings drawn from these sources are treated in depth in
[RESEARCH-BASIS.md](RESEARCH-BASIS.md): what the paper actually found, under what conditions,
the consideration drawn from it, and what that consideration does not license. Start there if
you want the reasoning rather than the list.
...
|---|---|---|---|
| `S-A01` | [LLMLingua: Compressing Prompts for Accelerated Inference of Large Language…](https://arxiv.org/abs/2310.05736) | peer-reviewed | R-21 |
| `S-A02` | [LongLLMLingua: Accelerating and Enhancing LLMs in Long Context Scenarios via…](https://arxiv.org/abs/2310.06839) | peer-reviewed | R-21 |
| `S-A03` | [LLMLingua-2: Data Distillation for Efficient and Faithful Task-Agnostic…](https://arxiv.org/abs/2403.12968) | peer-reviewed | R-21 |
...
| `S-A08` | [Understanding and Improving Information Preservation in Prompt Compression…](https://arxiv.org/abs/2503.19114) | peer-reviewed | R-21, R-S3 |
| `S-A09` | [When Compression Becomes an Attack Surface: Black-Box Attacks on…](https://arxiv.org/abs/2510.22963) | preprint | R-S1 |
| `S-A10` | [Separating Constraint Compliance from Semantic Accuracy: A Novel Benchmark…](https://arxiv.org/abs/2512.17920) | preprint | R-S1 |
...
| `S-B03` | [Context Rot: How Increasing Input Tokens Impacts LLM Performance](https://www.trychroma.com/research/context-rot) | technical-report | R-08, R-11, R-23 |
...
| `S-B06` | [Compressing Context to Enhance Inference Efficiency of Large Language Models…](https://arxiv.org/abs/2310.06201) | conference-paper | — |
| `S-B07` | [LongLLMLingua: Accelerating and Enhancing LLMs in Long Context Scenarios via…](https://arxiv.org/abs/2310.06839) | conference-paper | R-12 |
| `S-B08` | [RECOMP: Improving Retrieval-Augmented LMs with Compression and Selective…](https://arxiv.org/abs/2310.04408) | conference-paper | R-08, R-13 |
...
| `S-C03` | [Prompt caching (OpenAI official documentation — automatic prompt caching)](https://developers.openai.com/api/docs/guides/prompt-caching) | provider-doc | R-05, R-32 |
| `S-C04` | [Pricing (OpenAI official API pricing page)](https://developers.openai.com/api/docs/pricing) | provider-doc | R-05, R-34 |
...
| `S-C08` | [SGLang: Efficient Execution of Structured Language Model Programs…](https://arxiv.org/abs/2312.07104) | paper | R-05 |
| `S-C09` | [GPTCache: An Open-Source Semantic Cache for LLM Applications Enabling Faster…](https://aclanthology.org/2023.nlposs-1.24/) | paper | R-19 |
...
| `S-D04` | [Let Me Speak Freely? A Study on the Impact of Format Restrictions on…](https://arxiv.org/abs/2408.02442) | preprint | R-18 |
...
| `S-D09` | [Effective context engineering for AI agents](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) | engineering-report | R-02, R-08, R-11, R-14, R-20 |
...
| `S-D11` | [Not what you've signed up for: Compromising Real-World LLM-Integrated…](https://arxiv.org/abs/2302.12173) | preprint | R-S2 |
...
## Prompt sensitivity, in-context learning, evaluation & agent safety

| id | source | type | used by |
|---|---|---|---|
| `S-R01` | [Quantifying Language Models' Sensitivity to Spurious Features in Prompt Design](https://arxiv.org/abs/2310.11324) | peer-reviewed-conference | R-10, R-S3, R-24 |
...
| `S-R03` | [The Butterfly Effect of Altering Prompts](https://aclanthology.org/2024.findings-acl.275/) | peer-reviewed-findings | R-S3, R-24 |
...
| `S-R07` | [What Makes Good In-Context Examples for GPT-3?](https://aclanthology.org/2022.deelio-1.10/) | peer-reviewed-workshop | — |
...
| `S-R11` | [Executable Code Actions Elicit Better LLM Agents](https://proceedings.mlr.press/v235/wang24h.html) | peer-reviewed-conference | — |
| `S-R12` | [RedCode: Risky Code Execution and Generation Benchmark for Code Agents](https://arxiv.org/abs/2411.07781) | peer-reviewed-conference | — |
| `S-R13` | [Long-Context LLMs Meet RAG](https://arxiv.org/abs/2410.05983) | peer-reviewed-conference | — |
| `S-R14` | [JSONSchemaBench: A Rigorous Benchmark of Structured Outputs for Language…](https://arxiv.org/abs/2501.10868) | preprint | R-18 |
| `S-R15` | [Let Me Speak Freely? A Study On The Impact Of Format Restrictions](https://aclanthology.org/2024.emnlp-industry.91/) | peer-reviewed-conference | R-18 |
| `S-R16` | [Learning To Retrieve Prompts for In-Context Learning](https://aclanthology.org/2022.naacl-main.191/) | peer-reviewed-conference | — |
| `S-R17` | [CRANE: Reasoning with constrained LLM generation](https://arxiv.org/abs/2502.09061) | peer-reviewed-conference | R-18 |
| `S-R18` | [Benchmarking Complex Instruction-Following with Multiple Constraints…](https://arxiv.org/abs/2407.03978) | peer-reviewed-conference | R-10, R-26, R-27 |
...
| `S-R23` | [LLMs instead of Human Judges? A Large Scale Empirical Study across 20 NLP…](https://aclanthology.org/2025.acl-short.20/) | peer-reviewed-conference | R-29 |
...
| `S-R28` | [Fine-tuning Aligned Language Models Compromises Safety, Even When Users Do…](https://arxiv.org/abs/2310.03693) | peer-reviewed-conference | R-S1 |
...
| `S-R30` | [Adaptive Attacks Break Defenses Against Indirect Prompt Injection Attacks on…](https://aclanthology.org/2025.findings-naacl.395/) | peer-reviewed-findings | R-S2 |
